...
namespace SlimFormaturas.Service.Services
{
    public class AddressService : BaseService<Address>, IAddressService
    {
        ...
        public async Task<Address> Insert(Address obj) {
            Address address = new Address(obj.AddressId, obj.Cep, obj.Street, obj.Number, obj.Complement, obj.Neighborhood, obj.City, obj.Uf, await _typeGenericRepository.GetById(obj.TypeGenericId));
