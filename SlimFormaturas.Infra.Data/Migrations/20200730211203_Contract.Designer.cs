...
namespace SlimFormaturas.Infra.Data.Migrations
{
    ...
    [Migration("20200730211203_Contract")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SlimFormaturas.Domain.Entities.Contract", b =>
                {
            ...
            modelBuilder.Entity("SlimFormaturas.Domain.Entities.GraduateAlbum", b =>
                {
                    b.Property<string>("GraduateAlbumId")
                        .HasColumnName("Id")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("AlbumCode")
                        .IsRequired()
                        .HasColumnType("varchar(100)")
                        .HasMaxLength(100);

                    b.Property<int>("AmountPhotosAvailable")
                        .HasColumnType("int");

                    b.Property<int>("AmountPhotosScraps")
                        .HasColumnType("int");

                    b.Property<int>("AmountPhotosSold")
                        .HasColumnType("int");
                    ...
                    b.HasKey("GraduateAlbumId");

                    b.ToTable("GraduateAlbum");
                });
            ...
            modelBuilder.Entity("SlimFormaturas.Domain.Entities.GraduateAlbum", b =>
                {
                    b.HasOne("SlimFormaturas.Domain.Entities.Contract", "Contract")
                        .WithMany("GraduateAlbum")
                        .HasForeignKey("GraduateAlbumId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("SlimFormaturas.Domain.Entities.GraduateCeremonial", b =>
                {
                    b.HasOne("SlimFormaturas.Domain.Entities.Contract", "Contract")
                        ...
                        .HasForeignKey("GraduateCeremonialId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
